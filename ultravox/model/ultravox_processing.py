...
class UltravoxProcessor(transformers.ProcessorMixin):
    ...
    tokenizer: transformers.PreTrainedTokenizerBase #base Transformers tokenizer
    audio_processor: transformers.ProcessorMixin #base audio processor
    ...
    def __init__(
        ...
        encoder_ds_factor: int = 320,#reduce the dimensionality of the audio features.
        stack_factor: int = 8,# stack single input with 8 audio frames
        audio_placeholder: str = "<|audio|>",#used in text input to indicate the location of the audio input.
    ):
        """
        Args:
            audio_processor: The audio processor for the audio encoder.
